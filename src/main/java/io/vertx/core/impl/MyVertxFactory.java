...
public class MyVertxFactory {
    ...
    public MyVertxFactory(VertxOptions options) {
        this.options = options;
        this.clusterManager = options.getClusterManager();
    }

    public MyVertxFactory() {
        this(new VertxOptions());
    }

    public MyVertxFactory transport(Transport transport) {
        this.transport = transport;
        return this;
    }

    public MyVertxFactory clusterManager(ClusterManager clusterManager) {
        this.clusterManager = clusterManager;
        return this;
    }

    public MyVertxFactory clusterNodeSelector(NodeSelector clusterNodeSelector) {
        this.clusterNodeSelector = clusterNodeSelector;
        return this;
    }

    public MyVertxFactory tracer(VertxTracer tracer) {
        this.tracer = tracer;
        return this;
    }

    public MyVertxFactory metrics(VertxMetrics metrics) {
